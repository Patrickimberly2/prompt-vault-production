#!/usr/bin/env python3
"""
PromptVault 2.0 - Notion CSV Importer (Force Import)
This version adds [Notion] prefix to avoid duplicate detection
"""
...
def create_prompt_from_row(row):
    ...
    # Add [Notion] prefix to make titles unique
    unique_title = f"[Notion] {subpage_title}"
    
    # Create prompt object
    prompt = {
        'title': unique_title,  # Unique title with prefix
        'name': unique_title,
        'content': f"From ChatGPT Bible (Notion): {subpage_title}\n\nPrompts and templates for {subpage_title}.",
        'prompt_text': f"[{subpage_title}]: Use ChatGPT to assist with {subpage_title.lower()}. This includes strategies, templates, and best practices for effective implementation in {category}.",
...
def import_csv():
    ...
    print("=" * 70)
    print("🚀 NOTION CSV IMPORT - ChatGPT Bible (FORCE MODE)")
    print("=" * 70)
    print()
    print("ℹ️  This version adds [Notion] prefix to avoid duplicates")
    print()
        ...
        with open(CSV_PATH, 'r', encoding='utf-8') as f:
            ...
            for i, row in enumerate(rows, 1):
                try:
                    ...
                    # Check for duplicates (should be rare now with prefix)
    ...
    print("=" * 70)
    print()
    print("✅ All prompts imported with [Notion] prefix")
    print("✅ You can now filter by source: 'ChatGPT Bible (Notion)'")
    print()
    print("Next steps:")
    print("1. Run: python view_stats.py")
    print("2. Check your frontend!")
    print()
