#!/usr/bin/env python3
"""
PromptVault 2.0 - Notion CSV Importer
Imports prompts from chatgpt_bible_subpages.csv

This script:
1. Reads the CSV file with Notion page metadata
2. Extracts categories and page titles
3. Creates prompts from the structured data
4. Imports into Supabase with deduplication
"""
...
def create_prompt_from_row(row):
    ...
    # Skip BONUS pages (they're not actual prompts)
...
def import_csv():
    ...
    if not os.path.exists(CSV_PATH):
        ...
        print()
        print("Please update CSV_PATH in the script to point to your CSV file.")
        return
    ...
    try:
        ...
        categories = [cat['name'] for cat in result.data]
